...
export const Default: Story = {
  render: () => {
    const [tags, setTags] = React.useState<ReadonlyArray<TagEditorProps.Tag>>([
      { key: 'Environment', value: 'Production', existing: true },
    ]);

    const onChange = React.useCallback((event: NonCancelableCustomEvent<TagEditorProps.ChangeDetail>) => {
